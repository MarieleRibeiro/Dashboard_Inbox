...
import {
  Container, SearchBoxes, Label, Button, BoxMessage, Span, Content, Message,
  Strong, Small, HistoryMsg, TitleMsg
} from "./styles"
...
const inbox = [
  {
    ...
    description: "Hello John, I would really like to see some examples of the previous"
  }
]
